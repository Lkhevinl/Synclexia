...
const MESSAGES = {
  ...
  STT: [
    "Speech-to-Text! Tap the mic, speak clearly, and I'll write it down!",
  ...
  Writing: [
    "Writing practice! Follow the guide lines carefully.",
    "Take it slow — good handwriting takes practice! One letter at a time!",
    "Tracing helps your fingers remember the shape of each letter!",
  ],
  Spelling: [
  ...
  PhonologicalAwareness: [
    "Sound patterns! Listen for rhymes, syllables, and word words!",
  ...
  SpeechToText: [
    "Speak clearly into the mic and I'll turn your words into text!",
