...
export default function TeacherAddStoryScreen() {
  ...
  const openAdd = () => {
    setEditingId(null);
    setTitle(''); setContent(''); setLevel('1');
    setFormVisible(true);
  };
  ...
  const handleSave = async () => {
    ...
    Alert.alert('Success ✓', editingId ? 'Story updated!' : 'Story published!');
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
              ...
              <CustomButton title={editingId ? 'Update Story' : 'Publish Story'} onPress={handleSave} loading={saving} />
...
const styles = StyleSheet.create({
  ...
  storyCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 14, padding: 14, marginBottom: 10, elevation: 1 },
  levelBadge: { width: 36, height: 36, borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  ...
  levelBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#eee', justifyContent: 'center', alignItems: 'center' },
