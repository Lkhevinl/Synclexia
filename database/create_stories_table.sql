-- Create Stories Table for Writing Practice
-- This table stores reading comprehension stories for students
...
CREATE INDEX IF NOT EXISTS idx_stories_active_level
  ON public.stories (is_active, level);
